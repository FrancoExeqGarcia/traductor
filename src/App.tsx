...
import Translate from './services/Translate';import TranslateBox from './components/translateBox/TranslateBox';

function App() {
  const [sourceLanguage, setSourceLanguage] = useState<string>('en'); 
  const [targetLanguage, setTargetLanguage] = useState<string>('es');
  const [textToTranslate, setTextToTranslate] = useState<string>(''); 
  const [translatedText, setTranslatedText] = useState<string>('Aquí aparecerá tu traducción'); 
